...
This is the schema document for the LinkFlow LLM Wiki. It tells Codex how the wiki is structured, what conventions to follow, and what workflows to use for each operation.
...
These guidelines apply whenever Codex writes or edits code in this project.
