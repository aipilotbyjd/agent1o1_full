...
class Workspace extends Model
{
    ...
    use Billable, HasFactory, HasUuid;
    ...
    /**
     * @return HasMany<ArchivedExecutionLog, $this>
     */
    public function archivedExecutions(): HasMany
    {
        return $this->hasMany(ArchivedExecutionLog::class);
    }
